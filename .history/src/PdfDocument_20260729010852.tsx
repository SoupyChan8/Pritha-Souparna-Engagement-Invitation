...
const styles = StyleSheet.create({
  ...
  eventTime: { fontSize: 12, opacity: 0.8, width: "30%", textAlign: "left" },
  eventNameBox: { display: "flex", flexDirection: "row", alignItems: "center", width: "70%", justifyContent: "flex-end" },
